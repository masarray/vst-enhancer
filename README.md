...
**ArSonKuPik v0.5.9** provides 365 days of full editing from first launch on each computer. No account, internet connection, or audio watermark is required.
...
- [Download ArSonKuPik v0.5.9 Public Beta](https://github.com/masarray/vst-enhancer/releases/tag/v0.5.9)
