...
**ArSonKuPik v0.5.1** provides 365 days of full editing from first launch on each computer. No account, internet connection, or audio watermark is required.
...
The private **Key Activator** and RSA private signing key are intentionally not included in public downloads. Customers receive only the hardware-bound activation code generated by Mas Ari.

## Download

- [Download ArSonKuPik v0.5.1 Public Beta](https://github.com/masarray/vst-enhancer/releases/tag/v0.5.1)
