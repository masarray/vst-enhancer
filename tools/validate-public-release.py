...
def validate_page(text: str, language: str, canonical: str, version: str, static_hreflang: bool) -> None:
    ...
    require(software.get("softwareVersion")==version.lstrip("v") and software.get("url")==canonical and software.get("inLanguage")==language, f"{canonical} structured data mismatch")
