...
## v0.5.26 - 23 August 2026

### Cross-platform distribution

- Built and audited Windows x64 binaries locally on Windows.
- Built and audited macOS Universal binaries through the single approved manual workflow in `masarray/vst-enhancer`, using the exact `v0.5.26` tag and pinned commit from the private proprietary source repository.
